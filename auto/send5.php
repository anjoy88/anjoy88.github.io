<?php
	...
	$question = $_POST['question']; // Вытаскиваем вопрос в переменную
	$message = "<b>Форма:</b> $form <br> <b>Имя:</b> $name <br> <b>Телефон:</b> $tel <br> <b>Вопрос:</b> $question"; // Формируем сообщение, отправляемое на почту
	$to = "nookfray@gmail.com"; // Задаем получателя письма
	$from = "email@email.ru"; // От кого пришло письмо
	$subject = "АвтоРай - Вопрос мастеру"; // Задаем тему письма
